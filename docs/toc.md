...
### [Architecting Container and Microservice Based Applications](architecture/front-matter/)
#### [Introduction](architecture/introduction/)
#### [Introduction to Containers and Docker](architecture/introduction-to-containers-and-docker/)
#### [Choosing Between NET Core and NET Framework for Docker Containers](architecture/choosing-between-net-core-and-net-framework-for-docker-containers/)
#### [Architecting Container and Microservice Based Applications](architecture/architecting-container-and-microservice-based-applications/)
#### [Development Process for Docker Based Applications](architecture/development-process-for-docker-based-applications/)
#### [Deploying Single Container Based NET Core Web Applications on Linux or Windows Nano Server Hosts](architecture/deploying-single-container-based-net-core-web-applications-on-linux-or-windows-nano-server-hosts/)
#### [Migrating Legacy Monolithic NET Framework Applications to Windows Containers](architecture/migrating-legacy-monolithic-net-framework-applications-to-windows-containers/)
#### [Designing and Developing Multi Container and Microservice Based NET Applications](architecture/designing-and-developing-multi-container-and-microservice-based-net-applications/)
#### [Tackling Business Complexity in a Microservice with DDD and CQRS Patterns](architecture/tackling-business-complexity-in-a-microservice-with-ddd-and-cqrs-patterns/)
#### [Implementing Resilient Applications](architecture/implementing-resilient-applications/)
#### [Securing NET Microservices and Web Applications](architecture/securing-net-microservices-and-web-applications/)
#### [key takeaways](architecture/key-takeaways/)
